...
export const Subject = () => {
  ...
  const handle = (e) => {
    const newData = { ...data };
    newData["SUB_NAME"] = e.target.value;
    setData(newData);
  };
  ...
  const deleteSubject = (e, id) => {
    e.preventDefault();
    axios.delete(`${apiURL}subject/${id}`).then(() => window.location.reload());
  };
  ...
  return (
    <section className="Table">
          ...
          <tr className="DataTable-tr" key={key}>
            ...
            <td className="DataTable-td">
              <div className="DataTable-buttons">
                ...
                <button onClick={(e) => deleteSubject(e, item.SUB_ID)}>
                  <svg
                    clipRule="evenodd"
                    fillRule="evenodd"
      ...
      <Modal
        ...
        toggle={toggle}
      >
        <h3 className="Modal-title">{`Editar materia: ${subjectName}`}</h3>
      ...
      <Modal
        ...
        toggle={toggleCreate}
      >
        <h3 className="Modal-title">Agregar nueva materia</h3>
